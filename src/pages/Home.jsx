...
import storymain from "../assets/images/storysmall.jpg";
// title
...
function Home() {
    ...
    // ******
    const features = [
        [<FaFire />, 'Open-fire cooking', 'Charred edges and deep flavour from our stone oven.'],
        [<FaLeaf />, 'Market fresh', 'Seasonal produce selected every morning.'],
        [<FaClock />, 'Made to order', 'Every plate is prepared fresh for you.'],
        [<FaAward />, 'Craft & quality', 'Careful recipes, consistent standards.'],
    ]
        ...
        <main className="page">
                    ...
                    <Row className="align-items-center min-vh-100 py-5">
                        <Col lg={6} className="pt-5 pt-lg-0">
                            <div data-aos="fade-right">
                                ...
                                <h1>Food made to <span>remember.</span></h1>
                                <p>
                                    Modern comfort food, handcrafted pizzas and vibrant seasonal dishes,
                                    served in a warm space made for sharing.
                                </p>
                                <div className="hero-actions">
                                    <Link to="/menu" className="btn-primary-custom">Explore our menu <FaArrowRight /></Link>
                                    <Link to="/contact" className="btn-outline-custom">Book a table</Link>
                                </div>
                                <div className="hero-stats">
                                    <div><strong>12+</strong><span>Years of flavour</span></div>
                                    <div><strong>40+</strong><span>Signature dishes</span></div>
                        ...
                        <Col lg={6} className="text-center mt-5 mt-lg-0">
                            <div className="hero-image-frame" >
                                <img src={heroimg} alt="Fresh artisan pizza" className="hero-food-image" data-aos="fade-up" />
                    ...
                    <Row className="justify-content-center text-center mb-5">
                        <Col xs={12} md={10} lg={7}>
                            ...
                            <p className="favourites-description lead mb-0">
                                Discover a selection of our most popular dishes, prepared with
                ...
                <Container>
                    <Row className="align-items-center g-5">
                        ...
                        <Col lg={6} data-aos="fade-left">
                            ...
                            <h2 className="display-title">A neighbourhood table with a world of flavour.</h2>
                            <p>Syrup began with one simple idea: exceptional food should feel welcoming, not complicated. We combine Mediterranean warmth, Italian craft and modern techniques.</p>
                            <p>Our dough rests for 48 hours, sauces are prepared daily and every ingredient is chosen for flavour—not shortcuts.</p>
                            <Link to="/Story" className="text-link">Discover our story →</Link>
                        </Col>
                    </Row>
                </Container>
            </section>
            ...
            <section className="testimonial-section section-padding">
                <Container>
                    <div className="testimonial-card" data-aos="fade-up">
                        <FaQuoteLeft />
                        <p>“Beautiful atmosphere, genuinely warm service and one of the best pizzas we have had in the city.”</p>
            ...
            <section className="cta-section">
                <Container className="text-center position-relative">
                    ...
                    <Link to="/order" className="btn-light-custom">Start your order</Link>
                </Container>
            </section>
        </main>
    )
